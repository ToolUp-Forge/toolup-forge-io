              ...
              [
                ...
                div
                    ...
                    [ section
                          []
                          [ h3
                                [ _class "text-xs font-semibold uppercase tracking-wider text-muted mb-2" ]
                                [ str "Platform" ]
                            ul
                                [ _class "space-y-1" ]
                                [ li
...
let render (page: PublicPage) : XmlNode =
    ...
    let layoutBody =
        div
            [ _class "mx-auto max-w-7xl flex flex-1 w-full" ]
            [ docNav
              div
                  [ _class "flex-1 min-w-0 px-6 py-10 lg:px-10" ]
                  [ article
                        [ _class "prose prose-toolup max-w-3xl" ]
                        [ header
                              [ _class "mb-8" ]
                              [ h1
                                    [ _class "text-3xl font-semibold tracking-tight text-fg-emphasis" ]
                                    [ str page.Title ]
